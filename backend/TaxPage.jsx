    ...
    <div style={{ maxWidth: 1100, margin: '0 auto', padding: '40px 24px' }}>
      ...
      <div style={{ marginBottom: 40, animation: 'fadeUp 0.5s ease both' }}>
        ...
        <p style={{ color: 'var(--text-secondary)', maxWidth: 520, fontSize: 16 }}>
          Old vs New — computed with exact 2024-25 slabs. Claude explains what it means in plain Hindi-English.
        </p>
      </div>
            ...
            <div className="card card-gold" style={{ marginBottom: 28 }}>
              <div style={{ display: 'flex', gap: 12, alignItems: 'flex-start', marginBottom: 20 }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: 13, color: 'var(--text-secondary)' }}>Powered by Claude · SEBI-aware</div>
                </div>
              </div>
